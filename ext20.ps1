...
$f1  = $b + 'mcp-58c0745d-668a-4639-b569-2ea04a11af76-apollo_people_bulk_match-1773838824835.txt'
$f2  = $b + 'mcp-58c0745d-668a-4639-b569-2ea04a11af76-apollo_people_bulk_match-1773838826741.txt'
$files = $f1,$f2
...
# Inline p47b
$rows += $nl + 'Tim,Pennings,tim.pennings@hedwigsolutions.com,Hedwig Solutions INC,Chief Executive Officer'
$count += 1

[System.IO.File]::WriteAllText('C:\Users\ChadGriffith\Downloads\fileflo-f11afbf5-main (2)\compliance_proof_leads_batch20.csv', $rows)
