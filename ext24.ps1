...
$f1  = $b + 'mcp-58c0745d-668a-4639-b569-2ea04a11af76-apollo_people_bulk_match-1773839350059.txt'
$f2  = $b + 'toulu_01BuZ8zDkzZuLYTSrrMNZMUV.json'
$f3  = $b + 'mcp-58c0745d-668a-4639-b569-2ea04a11af76-apollo_people_bulk_match-1773839359407.txt'
$f4  = $b + 'toulu_016kZUf9BPzfx8m3fTGAEeYh.json'
$files = $f1,$f2,$f3,$f4
...
[System.IO.File]::WriteAllText('C:\Users\ChadGriffith\Downloads\fileflo-f11afbf5-main (2)\compliance_proof_leads_batch24.csv', $rows)
