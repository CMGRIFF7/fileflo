...
$f1  = $b + 'mcp-58c0745d-668a-4639-b569-2ea04a11af76-apollo_people_bulk_match-1773839130562.txt'
$f2  = $b + 'toulu_01LkRAsS7RamCHoW4BpXo47z.json'
$f3  = $b + 'toulu_011UNc5apLjVRZhTnRGE8Vmp.json'
$f4  = $b + 'toulu_016reESVVjzYzN2Y2oYM6Pps.json'
$files = $f1,$f2,$f3,$f4
...
[System.IO.File]::WriteAllText('C:\Users\ChadGriffith\Downloads\fileflo-f11afbf5-main (2)\compliance_proof_leads_batch22.csv', $rows)
