...
$f1  = $b + 'toulu_01WaLL7E8zc3tZeeauS9Y1z4.json'
$files = $f1
...
[System.IO.File]::WriteAllText('C:\Users\ChadGriffith\Downloads\fileflo-f11afbf5-main (2)\compliance_proof_leads_batch13.csv', $rows)
