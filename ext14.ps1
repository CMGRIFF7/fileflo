...
$f1  = $b + 'toulu_01GEZ1GwmCDttMQWSVpejDou.json'
$f2  = $b + 'toulu_01BaSNihUkGYbmV8GsbQsheu.json'
$files = $f1,$f2
...
[System.IO.File]::WriteAllText('C:\Users\ChadGriffith\Downloads\fileflo-f11afbf5-main (2)\compliance_proof_leads_batch14.csv', $rows)
