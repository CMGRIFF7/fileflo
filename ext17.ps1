...
$f1  = $b + 'mcp-58c0745d-668a-4639-b569-2ea04a11af76-apollo_people_bulk_match-1773838295111.txt'
$f2  = $b + 'toulu_016upa98cEoGuW4pkVAdNjQk.json'
$f3  = $b + 'toulu_017bF8cKofKapvPjkuGdqUSn.json'
$f4  = $b + 'toulu_019NRy1AdC2T75bqbHDoNgV3.json'
$files = $f1,$f2,$f3,$f4
...
[System.IO.File]::WriteAllText('C:\Users\ChadGriffith\Downloads\fileflo-f11afbf5-main (2)\compliance_proof_leads_batch17.csv', $rows)
