...
$f1  = $b + 'mcp-58c0745d-668a-4639-b569-2ea04a11af76-apollo_people_bulk_match-1773837296993.txt'
$f2  = $b + 'toulu_011TPfrVmoUs9GGuMif1cBBB.json'
$f3  = $b + 'toulu_01UkF8vBCJa3z8vnV3gfRXrc.json'
$files = $f1,$f2,$f3
...
# Inline results (p29b - returned directly, non-US skipped)
$rows += $nl + 'David,Harris,david@lightning-logistics.com,Lightning Logistics LLC,CEO'
$count += 1

[System.IO.File]::WriteAllText('C:\Users\ChadGriffith\Downloads\fileflo-f11afbf5-main (2)\compliance_proof_leads_batch11.csv', $rows)
